  ...
  <!-- 푸터틀 시작 -->
	...
	<div class="layout">
			<div class="footer-info">
					...
					<address class="pc_footer_wp">58567 전라남도 무안군 삼향읍 후광대로 282 전문건설회관 6층 &nbsp;/&nbsp; 사업자등록번호 : 411-82-11678 &nbsp;/&nbsp; 대표전화  : 061-287-1365 &nbsp;/&nbsp; E-mail : jnvc1365@hanmail.net  <p><?php echo visit('theme/basic'); // 접속자집계, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정 ?></p></address>
					<!-- <address class="mobile_footer_wp">58567 전라남도 무안군 삼향읍 후광대로 282 <br/>   대표전화 : 061-287-1365 <br/>E-mail : jnvc1365@hanmail.net<br/><?php echo visit('theme/basic'); ?></address> -->
