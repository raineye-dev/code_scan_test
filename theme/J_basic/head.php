...
?>
<link rel="stylesheet" href="/theme/J_basic/css/main_02.css" />
<div id="hd">
...
<!-- 스킵네비케이션끝 -->
<div class="top_link" id="new_top">
<div class="new_top_link_color">
  <div class="layout">
    <ul class="top_list1">
      <li><a href="https://www.jeonnam-gwangju.go.kr/" target="_blank" title="새창열림" rel="noopener noreferrer">전남광주통합특별시</a></li>
...
<header id="top_layout" class="new_top_layout"> 
  <!-- gnb_layout :s --> 
<!--   <script type="text/javascript">
  ...
  <nav id="gnb_layout" class="new_gnb_area">
    <div id="gnb"> 
      <!-- 공통메뉴틀 시작 -->
            ...
            <div class='item'>
              ...
              <div class='gnb-depth'>
                <ul class='depth2_ul'>
				   ...
				   <li class=""> <a href='/bbs/sub/sub_page_03_05.php' target='_self'  ><em></em><span>가고싶은 전남 볼런투어</span></a> </li>
				   ...
				   <li> <a href='/bbs/sub/sub_page_03_07.php' target='_self'  ><em></em><span>나눔 이동 세탁차</span></a> </li>
				    ...
				    <li > <a href='/bbs/sub/sub_page_03_08.php' target='_self'  ><em></em><span>전남 청년봉사단 운영</span></a> </li>
                </ul>
              </div>
            </div>
          </li>
  ...
  <div class="modal fade" id="mobile-menu" role="dialog" aria-hidden="true">
    <div class="modal-dialog" id="new_modal-dialog" role="document">
                ...
                <ul class='depth2_ul'>
                  <li>  <a href='/bbs/sub/sub_page_03_01.php' target='_self'  ><em></em><span>블루 재능 봉사단</span></a> 
				   ...
				   <li> <a href='/bbs/sub/sub_page_03_07.php' target='_self'  ><em></em><span>나눔 이동 세탁차</span></a> 
				    ...
				    <li> <a href='/bbs/sub/sub_page_03_08.php' target='_self'  ><em></em><span>전남 청년봉사단 운영</span></a> 
				   </li>
                </ul>
              </div>
            </div>
...
<?php
list($sv_menu) = array_map('trim', explode('|', $g5['title']));
// 게시판에서는 게시판명 대신 1차 메뉴명으로 표기 (메뉴 관리 미사용으로 수동 매핑)
$sv_menu1 = array(
	'sub_page_03_01' => '센터소식', 'sub_page_03_02' => '센터소식', 'sub_page_03_03' => '센터소식',
	'sub_page_03_04' => '센터소식', 'sub_page_03_05' => '센터소식', 'sub_page_03_06' => '센터소식',
	'sub_page_03_10' => '센터소식', 'sub_page_03_12' => '센터소식', 'sub_page_05_01' => '센터소식',
	'sub_page_03_01_002' => '주요사업', 'sub_page_03_11' => '주요사업',
	'hall_of_fame' => '인정보상', 'biz_info' => '인정보상',
);
if (!empty($board['bo_table']) && isset($sv_menu1[$board['bo_table']])) $sv_menu = $sv_menu1[$board['bo_table']];
?>
<div id="svisual_layout_new">
	<div class="svisual_wrap">
		<div class="sub__background"></div>
		<div class="subvisual-layout">
		  <div class="layout_sub svisual_01"> 
			<h2><span><?php echo get_text($sv_menu); ?></span></h2>
			<p class="subvisual-layout__text">자원봉사의 빛으로 함께 밝히는 전남광주</p>
		  </div>
		</div>
	</div> 
</div><!----////svisual_layout----->
