	...
	<aside id="lnb_layout" class="lnb_wrap">
      <div class="title_wrap lnb__title"><strong>자원봉사교육</strong> </div>
		<ul id="snb" class="depth2_ul lnb_depth2__list n4">
			...
			<li class="<?php if($basename == 'sub_page_04_04.php') { echo 'on'; } ?>"><a href="/bbs/sub/sub_page_04_04.php" target="_self"><span style="background-color: #112b59; color: #fff;">온라인 인증현황</span></a> </li>
		</ul>
    </aside><!---///lnb_wrap--->
