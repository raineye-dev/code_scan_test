...
*/?>
    ...
    <div class="btn_confirm btn_submits">
        
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel btn2 btn_submit">취소</a>
		<input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn_submit btn2 btn_submit_right">
    </div>
    </form>

    <script>
	$(function(){ // 날짜 입력
		$("#wr_1").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yymmdd", showButtonPanel: true });  //, #wr_2
	});
