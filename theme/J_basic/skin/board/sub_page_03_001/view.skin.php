...
<div class="tbl_head01 tbl_wrap board_list">
	<table class="table_t02">
		...
		<tr>
			<th class="w12">단체명</th>
			<td class="if_date"><?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력 ?></td>
		</tr>
		<tr>
			<th class="w12">대표자명</th>
			<td class="if_date ">
				<?php echo mb_substr($view['wr_6'],0,1,'utf-8')  ?>**
			</td>
		</tr>

		<tr>
			<th class="w12">활동분야</th>
			<td class="if_date "><?php echo $view['wr_5']; ?></td>
		</tr>
	
		<tr>
			<th class="w12">활동내용</th>
			<td class="if_date "><?php echo $view['wr_content']; ?></td>
		</tr>
		<tr>
			<th class="w12">회원수</th>
