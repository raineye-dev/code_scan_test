...
<div id="body_layout">
 ...
 <?include G5_THEME_PATH."/sub_left_09.php"?>


    <div id="contens" class="contents_wrap">
      <div id="location" class="title_wrap">
        <h2 class="page__title">뉴스레터</h2>
        <!-- 유틸 시작 -->
        <div class="utile_wrap"> 
          <ul class="location_wrap">
            <li class="n1 navi_home"><a href="">HOME</a></li>
            <li class="n2"><a href="">센터소식</a></li>
            <li class="n3"><a href="" class="navi_ov">뉴스레터</a></li>
         </ul>
        </div><!---///utile_wrap---->
...
<!----/// html----->
<script src="/theme/J_basic/skin/board/sub_03_04_notice/js/imageMapResizer.min.js"></script>
