  ...
  <div class="body_wrap layout"> 
    ...
    <aside id="lnb_layout" class="lnb_wrap">
      ...
      <ul id="snb" class="depth2_ul lnb_depth2__list n4">
            <li><a href="/bbs/board.php?bo_table=sub_page_03_01" target="_self"><span>공지사항</span></a> </li>
		...
		<li class="on"><a href="/bbs/board.php?bo_table=sub_page_05_01" target="_self"><span>22색 이야기</span></a> </li>
    ...
    <div id="contens" class="contents_wrap">
      <div id="location" class="title_wrap">
        <h2 class="page__title">활동앨범</h2>
        <!-- 유틸 시작 -->
        <div class="utile_wrap"> 
          <ul class="location_wrap">
            <li class="n1 navi_home"><a href="">HOME</a></li>
            <li class="n2"><a href="">센터소식</a></li>
            <li class="n3"><a href="" class="navi_ov">활동앨범</a></li>
         </ul>
        </div><!---///utile_wrap---->
...
<!--     <div id="bo_v_share">
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_left btn_submits">
            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_submit"> 수정</a></li><?php } ?>
            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_submit" onclick="del(this.href); return false;">삭제</a></li><?php } ?>
        ...
        <ul class="bo_v_com btn_submits">
           <li><a href="<?php echo $list_href ?>" class="btn_submit"> 목록</a></li>
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn_submit_right">글쓰기</a></li><?php } ?>
        </ul>
