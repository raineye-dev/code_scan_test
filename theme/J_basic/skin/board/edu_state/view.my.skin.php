...
?>
   ...
   <div class="tbl_head01 tbl_wrap board_list">
	<table class="tbl-basic">
		...
		<tr>
			<th>진행상태</th><td class="list_view_text" >상태</td>
		</tr>
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con" class="cont_view_wp"><?php echo html_entity_decode(get_view_thumbnail($view['content'])); ?></div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           <li><a href="<?php echo $list_href ?>&myp=o" class="btn_submitwp">목록</a></li>
        </ul>
