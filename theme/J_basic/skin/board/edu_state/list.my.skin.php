...
<div class="cntsGuide descript"> 
	<strong class="type1">회원님의 온라인 자원봉사 영상 교육 이수 여부 확인,<br>수료증 발급을 하실 수 있습니다.</strong>
 </div>
  ...
  <div id="bo_list" style="width:<?php echo $width; ?>">
	...
	<div><span class="my_name_text"><?=$member['mb_name'] ?></span> 님 반갑습니다.</div>
	...
	<div class=" education_box">
		<div class="subpoint"><span class="dot"><em></em></span><p class="tt1"><?=date('Y')?> 온라인영상교육 : 완료</p></div>
	</div>
