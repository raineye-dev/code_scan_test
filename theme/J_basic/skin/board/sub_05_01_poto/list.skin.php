  ...
  color:#fff;
    ...
    <div class="bo_fx">
        <div id="bo_list_total">
            <span>Total <?php echo number_format($list) ?>건</span>
            <?php echo $page ?> 페이지
        </div>
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="<?php echo $style ?>width:<?php echo $board['bo_gallery_width'] ?>px">
            ...
            <ul class="gall_con">
				<li>
					<?if($list[$i][wr_1]){?>
					<div style="width:50%;padding:5px 0;float:left;background-color:#808080;color:#fff;font-size:14px;font-weight:bold;"><?=$list[$i][wr_1]?></div>
					<div style="width:50%;padding:5px 0;float:left;background-color:#C0C0C0;color:#fff;font-size:14px;font-weight:bold;"><?=$list[$i][wr_2]?></div>
					<?}?>
				</li>
                <li class="gall_href">
                ...
                <li class="gall_text_href" style="width:<?php echo $board['bo_gallery_width'] ?>px; font-size:15px;">
                    <?php
