        ...
        <tr>
            ...
            <td>
				<?
					...
					$cat3 = explode('|',$board[bo_3]);
					$cat4 = explode('|',$board[bo_4]);
					$cat5 = explode('|',$board[bo_5]);
				?>
				...
				<?if(!$write[wr_1]){?>
					...
					<option id = "<?=$i?>"value="<?=$cat1[$i]?>">1<?=$cat1[$i]?></option>
					<option id = "<?=$i?>"value="<?=$cat2[$i]?>">2<?=$cat2[$i]?></option>
					<option id = "<?=$i?>"value="<?=$cat3[$i]?>">3<?=$cat3[$i]?></option>
					<option id = "<?=$i?>"value="<?=$cat4[$i]?>">4<?=$cat4[$i]?></option>
					<option id = "<?=$i?>"value="<?=$cat5[$i]?>">5<?=$cat5[$i]?></option>
					<?}?>
				<?}else{?>
