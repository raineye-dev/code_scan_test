              ...
              <div class="ds-ct">
                <div class="calendar">
                  <div class="cal">
					...
					?>"  class="month-prev"><i class="fa fa-chevron-left"> 지난달</i> </a>
                      <h5> <a href="<?php 
							echo $_SERVER['PHP_SELF']."?bo_table=".$bo_table; 
							?>" title="오늘로" onFocus="this.blur()"><?php echo "{$year}년&nbsp;{$month}월"; ?> </a></h5>
                      <a href="<?php 
						echo $_SERVER['PHP_SELF']."?bo_table={$bo_table}&";
						if ($month == '12') { 
							$year_pre  = $year+1; 
						...
						echo "year={$year_pre}&month={$month_pre}&sc_no={$sc_no}";
					?>"  class="month-next">다음달 <i class="fa fa-chevron-right"></i> </a> </div>
                    <div>
		...
		?>
                  ...
                  <div class="today-items">
                    <section id="today_schedule">
                      <h5><i class="far fa-clock"></i>금일 주요세탁일정</h5>
                      <div>
                        <?php 
							...
							while ($row = sql_fetch_array($result)) {  // 제목글 뽑아서 링크 문자열 만들기..
								...
								echo "<p>";
								echo "<span class='category category4'>세탁일정</span>";
            ...
            <div class="ds-ct"> 
              ...
              <!-- <div class="daylist"> <h5>이달의 세탁일정</h5> </div> -->
              <div class="daylist">
                <div class="subpoint line"><span class="dot"><em></em></span>
                  <p class="tt1">이달의 세탁일정</p>
                </div>
              </div>
              <div class="event_box">
                <?php
...
if($today_sc == 'N'){
		...
		?>
            ...
            <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_admin btn"><i class="fa fa-user-circle" aria-hidden="true"></i> 관리자</a></li><?php } ?> -->
                <?php if ($write_href) { ?>
                <li><a href="<?php echo $write_href ?>" class="btn_b02 btn btn_submit_right">일정추가</a></li>
                <?php } ?>
              </ul>
              <?php } ?>
