...
<ul>
        ...
        <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php if ($is_good) { ?><td class="td_num"><?php echo $list[$i]['wr_good'] ?></div><?php } ?>
            <?php if ($is_nogood) { ?><td class="td_num"><?php echo $list[$i]['wr_nogood'] ?></div><?php } ?>

 
        <?php } ?>
        <?php if (count($list) == 0) { echo '<ul><li class="empty_table">게시물이 없습니다.</li></ul>'; } ?>
		       </li>
		</ul>
    </div>
	<!-- 페이지 -->
