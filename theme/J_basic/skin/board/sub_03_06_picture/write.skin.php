...
<div class="write_div">
    ...
    <div class="btn_confirm write_div">
		<ul class="btn_bo_user  btn_submits">
         <li><a href="<?php echo get_pretty_url($bo_table); ?>"  class="btn_cancel btn_submit">취소</a></li>
          <li><button type="submit" id="btn_submit" accesskey="s" class="btn_submit  btn_submit_righ">작성완료</button></li>
		</ul>
    </div>
    </form>
