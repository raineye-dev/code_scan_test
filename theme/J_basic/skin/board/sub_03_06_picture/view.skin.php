 ...
 <?include G5_THEME_PATH."/sub_left_05.php"?>
    ...
    <div id="contens" class="contents_wrap">
      <div id="location" class="title_wrap">
        <h2 class="page__title">활동영상</h2>
        <!-- 유틸 시작 -->
        <div class="utile_wrap"> 
          <ul class="location_wrap">
            <li class="n1 navi_home"><a href="">HOME</a></li>
            <li class="n2"><a href="">센터소식</a></li>
            <li class="n3"><a href="" class="navi_ov">활동영상</a></li>
         </ul>
        </div><!---///utile_wrap---->
...
;
  ...
  ?>
  <div class="view_video" style="padding-bottom:12px; text-align:center;">
      <iframe width="940" height="409" src="https://www.youtube.com/embed/<?=$tmp_wr_link1[1];?>?rel=0&autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
          ...
          <!-- 본문 내용 시작 { -->
         <!--  <div id="bo_v_con"><?php echo get_view_thumbnail($view['content']); ?></div>----본문-- -->
