    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="write_div">
            <input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" readonly id="wr_1" required class="frm_input required" size="8" maxlength="8"> ~ <input type="text" name="wr_2" value="<?php echo $write['wr_2']; ?>" readonly id="wr_2" required class="frm_input required" size="8" maxlength="8">
			 ...
			 <label for="wr_schedule" class="sound_only">일정선택<strong>필수</strong></label>

			 <select name="wr_schedule" class="required" required>
				<option value="">일정선택</option>
				<option value="CS">센터일정</option>
				<option value="NM">나눔이동세탁차</option>
			</select>
        </div>
...
<!-- 
    <div class="btn_confirm write_div">
		...
		<ul class="btn_bo_user  btn_submits">
          ...
          <li><input type="submit" value="작성완료" id="btn_submit" accesskey="s" class=" btn_submit_right"></li>
		</ul>
    </div>
    </form>
