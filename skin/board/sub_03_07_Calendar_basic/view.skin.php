...
<div id="body_layout">
  <div class="body_wrap layout"> 
    ...
    <li><a href="/bbs/board.php?bo_table=sub_page_03_01" target="_self"><span>공지사항</span></a> </li>
		...
		<li><a href="/bbs/board.php?bo_table=sub_page_05_01" target="_self"><span>22색 이야기</span></a> </li>
		<li><a href="/bbs/board.php?bo_table=sub_page_03_06" target="_self"><span>활동영상</span></a> </li>
		<li class="on"><a href="/bbs/board.php?bo_table=sub_page_03_07" target="_self"><span>센터일정</span></a> </li>
...
<!-- 
 ...
 -->
        ...
        <ul class="bo_v_com  btn_submits">
           <li><a href="<?php echo $list_href ?>" class="btn_b01 btn_submit">목록</a></li>
            <!-- <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a></li><?php } ?> -->
