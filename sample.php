...
$searchHopeArea2= ($searchHopeArea2) ? $searchHopeArea2 : "";
...
//jsonUrl=https%3A%2F%2Fwww.1365.go.kr%2Fvols%2FP9210%2Fmber%2FvolsMberJson.do&searchFlag=search&cPage=1&nanmmbyId=&srchSido=6460000&srchSigu=4840000&srchFclty=&srchDnttNm=
  ...
  $postdata = array(
	...
	"searchHopeArea2"=>$searchHopeArea2
  );
  //print_r($postdata);
...
$html_str = str_replace("timeCptn.do?","https://www.1365.go.kr/vols/1572247904127/partcptn/timeCptn.do?",$html_str);
