...
function answerCheck(){
	...
	*/
	...
	answer_set = ahead_check_answer+ "," + check_answer;
	totalGradeSend(answer_set);
}
function totalGradeSend(aStr){
	//var answer = [1,2,2,4,1,3,2,3,3];   
	var answer = [2,4,1,2,3,1,2,4,2,3];   
...
<div class="subpoint"><span class="dot"><em></em></span><p class="tt1">청소년 온라인 영상교육 #03</p></div><!----////타이틀---->
...
<div class="contents">
    ...
    <p class="movie_text alignC"> ※온라인 동영상을(26초) 끝까지 수강하시면 <span class="emph_orange">다음문제</span>로 넘어가실수 있습니다.</p>
