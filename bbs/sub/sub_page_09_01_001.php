...
<div class="sub_table_wrap">
 <table class="table_t02">
    ...
    <tbody class="text_left01">
	  ...
	  <tr>
        <th>수료증</th>
        <td class="right"><a onClick="printImage('<?=$row['idx']?>')" style="cursor:pointer; 
		cursor: pointer;
    display: block;
    width: 150px;
    height: 30px;
    ...
    text-align: center;
		...
		">[수료증 다운로드 <i class="fa fa-floppy-o" aria-hidden="true"></i> ]</a></td>
...
<div class="btn_submits">
			<a href="/bbs/sub/sub_page_09_01.php" class="btn_submit_right">목록으로</a>
		</div>
