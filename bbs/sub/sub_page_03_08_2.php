                ...
                <table class="table table-bordered text-center" style="vertical-align:middle; word-break:keep-all; min-width:800px;">
                    <thead>
                        <tr style="background-color:#00349a; color:#fff;">
                            ...
                            <th style="padding:15px 5px;">청년봉사단<br>전문기술교육</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="padding:20px 10px; line-height:1.6;">분야별 전문교육<br>- 교육수강반<br>- 재능기부반<br>정기회의<br>간담회, 워크숍</td>
                    ...
                    <tfoot>
                        <tr style="background-color:#e6eff9; font-weight:bold;">
                            <td style="padding:15px 10px;">1단계 (1~3월)</td>
                            <td style="padding:15px 10px;">2단계 (6월)</td>
                            <td style="padding:15px 10px;">3단계 (6~10월)</td>
                            <td style="padding:15px 10px;">4단계 (7~11월)</td>
